local M = {
  ...
  config = function()
    ...
    keymap("n", "<leader>sl", "<cmd>Lspsaga show_line_diagnostics<CR>", { desc = "LSP Show Line Diags" })

    -- Show cursor diagnostics
    -- Like show_line_diagnostics, it supports passing the ++unfocus argument
    keymap("n", "<leader>sc", "<cmd>Lspsaga show_cursor_diagnostics<CR>", { desc = "LSP Show Cursor Diags" })

    -- Show workspace diagnostics
    keymap("n", "<leader>sw", "<cmd>Lspsaga show_workspace_diagnostics<CR>", { desc = "LSP Show Workspace Diags" })

    -- Show buffer diagnostics
    keymap("n", "<leader>sb", "<cmd>Lspsaga show_buf_diagnostics<CR>", { desc = "LSP Show Buffer Diags" })

    -- Diagnostic jump
    -- You can use <C-o> to jump back to your previous location
    keymap("n", "[e", "<cmd>Lspsaga diagnostic_jump_prev<CR>", { desc = "LSP Diags Jump Prev" })
    keymap("n", "]e", "<cmd>Lspsaga diagnostic_jump_next<CR>", { desc = "LSP Diags Jump Next" })
